...
var Buffer = require('buffer/').Buffer, defaultProvider = "https://tezrpc.me/api", library = {
...
node = {
    ...
    rpc = {
        ...
        setDelegate: function (keys, account, delegate, fee) {
            var operation = {
                "kind": "delegation",
                "delegate": (typeof delegate != "undefined" ? delegate : keys.pkh),
            };
    ...
    return node.query('/blocks/head')
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, eztz.alphanet.sleep(500)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, node.query('/blocks/prevalidation/proto/context/contracts/' + npkh + '/manager')];
                }
            });
        });
    })
